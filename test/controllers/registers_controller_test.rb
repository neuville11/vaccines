...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { doctorId: @register.doctorId, dosisNumber: @register.dosisNumber, patientId: @register.patientId, vaccineId: @register.vaccineId }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { doctorId: @register.doctorId, dosisNumber: @register.dosisNumber, patientId: @register.patientId, vaccineId: @register.vaccineId }
    assert_redirected_to register_path(assigns(:register))
  end
