...
class VaccinesControllerTest < ActionController::TestCase
  ...
  test "should create vaccine" do
    assert_difference('Vaccine.count') do
      post :create, vaccine: { controlNumber: @vaccine.controlNumber, description: @vaccine.description, name: @vaccine.name }
    end
  ...
  test "should update vaccine" do
    patch :update, id: @vaccine, vaccine: { controlNumber: @vaccine.controlNumber, description: @vaccine.description, name: @vaccine.name }
    assert_redirected_to vaccine_path(assigns(:vaccine))
  end
